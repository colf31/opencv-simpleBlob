...
//            Log.d(TAG, "filePath="+filePath);
      ...
      /* MatOfRect faces = new MatOfRect();
        ...
        for (Rect rect : faceArray) { // 给找到的人脸标上相框
         ...
         mSimpleBlobDetector.detect(mRgba,mKeyPoint);
          Features2d.drawKeypoints(mRgba,mKeyPoint,mRgba,FACE_RECT_COLOR, Features2d.DrawMatchesFlags_DRAW_RICH_KEYPOINTS);
    ...
    public  void initSimpleBlobParams(){
        mSimpleBlobDetectorParams=new SimpleBlobDetector_Params();

        mSimpleBlobDetectorParams.set_minThreshold(127);
        ...
        mSimpleBlobDetectorParams.set_minArea(20);
        mSimpleBlobDetectorParams.set_maxArea(1000);
        ...
        mSimpleBlobDetectorParams.set_filterByConvexity(false);

        mSimpleBlobDetectorParams.set_filterByColor(true);
